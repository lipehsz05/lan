<?php
    ...
    // Consulta para obter anúncios recentes
    $sql = "SELECT nome_completo, usuario, email, titulo, subtitulo, descricao, categoria, imagem, TIMESTAMPDIFF(MINUTE, data_criacao, NOW()) AS minutos_passados FROM anuncios ORDER BY data_criacao DESC LIMIT 5";
...
<body>
    ...
    <?php include 'navbar-deslogado.php'; ?>
    <!--Começo Anuncio-->
    ...
    <div class="conteudo">
        <?php while ($anuncio = $result->fetch_assoc()) { ?>
            <div class="conteudo-anuncio">
                <img src="<?php echo 'caminho_base/' . $anuncio['imagem']; ?>" alt="" class="img-anuncios" />
